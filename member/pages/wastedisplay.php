  ...
  <div class="container">
    <div class="details">
      ...
      <?php
        ...
        $sql = "SELECT * FROM `tbl_waste` WHERE `status`='1'";
        ...
        if (!$result) {
           ...
           while ($row = mysqli_fetch_array($result)) {
                 ...
                 echo" <p>Waste type: ".$row['wastetype']."</p>";
                  ...
                  echo'<a href="../action/wasteapprove.php?id='.$row['id'].'"><button name="approve" class="approve-button">Collect the waste</button></a>';
                 echo "</div>";
